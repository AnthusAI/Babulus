  ...
  return (
    <div className="container py-24 space-y-24">
      ...
      <div className="grid gap-16">
        {pairings.map((pair) => (
          <div key={pair.id} className="space-y-8 p-8 border rounded-xl bg-card">
            ...
            <div className="grid md:grid-cols-2 gap-12">
              ...
              <div className="space-y-4">
                <div className="aspect-video w-full rounded-lg bg-muted flex items-center justify-center relative overflow-hidden group">
                  ...
                  <div className="absolute bottom-4 right-4 max-w-[240px] bg-background/90 backdrop-blur p-4 rounded shadow-lg border">
